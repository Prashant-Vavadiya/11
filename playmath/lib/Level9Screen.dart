...
import 'package:playmath/Wow9Screen.dart';
...
class Level9Screen extends StatefulWidget {
  const Level9Screen({Key? key}) : super(key: key);
      ...
      body: Column(
        children: [
          ...
          Row(
            ...
            children: [
              Text("How many Birds?",style: TextStyle(fontSize: 25,fontWeight: FontWeight.w500,color: Color(0xffEE8B60)),)
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Container(
                ...
                child: Image.asset('assets/Image/Bird.png',fit: BoxFit.fill,),
              )
            ],
          ),
          SizedBox(
          ...
          Row(
            ...
            children: [
              InkWell(
                onTap: (){
                  Navigator.push(context,MaterialPageRoute(builder:(context)=> Wow9Screen()));
                },
                child: Container(
                  height: 50,
                  width: 120,
