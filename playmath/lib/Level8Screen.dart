...
import 'package:playmath/Wow8Screen.dart';
import 'package:playmath/homeProvider.dart';
import 'package:provider/provider.dart';

import 'wanswerScreen.dart';

class Level8Screen extends StatefulWidget {
  const Level8Screen({Key? key}) : super(key: key);
      ...
      body: Column(
        children: [
          ...
          Row(
            ...
            children: [
              Text("How many Rebbits?",style: TextStyle(fontSize: 25,fontWeight: FontWeight.w500,color: Color(0xffEE8B60)),)
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Container(
                ...
                child: Image.asset('assets/Image/Rebit.png',fit: BoxFit.fill,),
              )
            ],
          ),
          SizedBox(
          ...
          Row(
            ...
            children: [
              ...
              InkWell(
                onTap: (){
                  Navigator.push(context,MaterialPageRoute(builder:(context)=> Wow8Screen()));
                },
                child: Container(
                  height: 50,
                  width: 120,
